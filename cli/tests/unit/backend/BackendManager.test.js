...
describe('BackendManager', () => {
    ...
    describe('start', () => {
        ...
        it('should start the backend successfully', async () => {
            ...
            expect(mockProcessManager.spawn).toHaveBeenCalledWith('uv', ['run', 'python', 'main.py', '--port', '8080'], expect.objectContaining({
                cwd: '/test/project',
        ...
        it('should not start if already running', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Backend already running'), 12345);
        });
        it('should use alternative port if preferred is busy', async () => {
            ...
            await manager.start();
            expect(mockProcessManager.spawn).toHaveBeenCalledWith('uv', ['run', 'python', 'main.py', '--port', '8081'], expect.anything());
        });
