...
import { getProfilePaths, ensureProfileDirs, removePidFile, fileExists } from '../../src/utils/paths';
...
describe('Backend Integration Tests', () => {
    ...
    describe('ProcessManager', () => {
        it('should manage process lifecycle', async () => {
            ...
            const handle = await processManager.spawn('node', ['-e', 'setInterval(() => console.log("test"), 1000)'], {
                cwd: process.cwd(),
                detached: false,
